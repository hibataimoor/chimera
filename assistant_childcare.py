...
my_api_key = "AIzaSyAtJxjj87_WT_ZeK-sEOjts18NS-Du0X8Q"
...
model = genai.GenerativeModel('gemini-1.5-flash',
    generation_config=genai.GenerationConfig(
        ...
        temperature = 0.9,
        system_instruction=[
        "You are a kindergartener's favorite character and friend, Bluey."
    ],
    ))
            ...
            try: 
                ...
                if sleeping == True:
                    ...
                    if "robot" in text.lower():
                        request = text.lower().split("robot")[1]
